        ...
        <section className="min-h-screen flex flex-col items-center justify-center px-6 py-16">
          <div className="max-w-4xl mx-auto w-full">
            ...
            <div className="flex gap-4 justify-center">
              <a
                href="#"
                className="px-6 py-3 rounded-lg bg-[#161b22] text-[#8b949e] font-medium border border-[#3b4a5c] hover:border-[#6e5b8a]/50 hover:text-[#c9d1d9] transition-colors flex items-center gap-2"
              >
